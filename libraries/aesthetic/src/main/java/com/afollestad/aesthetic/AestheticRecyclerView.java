...
public class AestheticRecyclerView extends RecyclerView { //NOSONAR

  private Disposable subscription; //NOSONAR

  public AestheticRecyclerView(Context context) { //NOSONAR
    super(context); //NOSONAR
  } // NOSONAR

  public AestheticRecyclerView(Context context, AttributeSet attrs) { //NOSONAR
    super(context, attrs); //NOSONAR
  } // NOSONAR

  public AestheticRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) { //NOSONAR
    super(context, attrs, defStyleAttr); //NOSONAR
  } // NOSONAR

  private void invalidateColors(int color) { //NOSONAR
    EdgeGlowUtil.setEdgeGlowColor(this, color, null); //NOSONAR
  } // NOSONAR
