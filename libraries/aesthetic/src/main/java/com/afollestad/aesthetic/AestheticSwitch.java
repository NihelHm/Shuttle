...
public class AestheticSwitch extends Switch { //NOSONAR

  private Disposable subscription; //NOSONAR
  private int backgroundResId; //NOSONAR

  public AestheticSwitch(Context context) { //NOSONAR
    super(context); //NOSONAR
  } // NOSONAR

  public AestheticSwitch(Context context, AttributeSet attrs) { //NOSONAR
    super(context, attrs); //NOSONAR
    init(context, attrs); //NOSONAR
  } // NOSONAR

  public AestheticSwitch(Context context, AttributeSet attrs, int defStyleAttr) { //NOSONAR
        ...
        Observable.combineLatest( //NOSONAR
            ...
            .subscribe( //NOSONAR
                new Consumer<ColorIsDarkState>() { //NOSONAR
                  @Override //NOSONAR
                  public void accept(@NonNull ColorIsDarkState state) { //NOSONAR
                    invalidateColors(state); //NOSONAR
                  } // NOSONAR
                }, // NOSONAR
