...
public class AestheticButton extends AppCompatButton { //NOSONAR

  private Disposable subscription; //NOSONAR
  private int backgroundResId; //NOSONAR

  public AestheticButton(Context context) { //NOSONAR
    super(context); //NOSONAR
  } // NOSONAR

  public AestheticButton(Context context, AttributeSet attrs) { //NOSONAR
    super(context, attrs); //NOSONAR
    init(context, attrs); //NOSONAR
  } // NOSONAR

  public AestheticButton(Context context, AttributeSet attrs, int defStyleAttr) { //NOSONAR
  ...
  private void invalidateColors(ColorIsDarkState state) { //NOSONAR
    ...
    ColorStateList textColorSl = //NOSONAR
        new ColorStateList( //NOSONAR
            new int[][] { //NOSONAR
              new int[] {android.R.attr.state_enabled}, new int[] {-android.R.attr.state_enabled} //NOSONAR
            }, // NOSONAR
            new int[] { //NOSONAR
              Util.isColorLight(state.color()) ? Color.BLACK : Color.WHITE, //NOSONAR
              state.isDark() ? Color.WHITE : Color.BLACK //NOSONAR
            }); // NOSONAR
    setTextColor(textColorSl); //NOSONAR
  } // NOSONAR
