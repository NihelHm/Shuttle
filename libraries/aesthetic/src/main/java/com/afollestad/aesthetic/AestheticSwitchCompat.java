...
public class AestheticSwitchCompat extends SwitchCompat { //NOSONAR

  private Disposable subscription; //NOSONAR
  private int backgroundResId; //NOSONAR

  public AestheticSwitchCompat(Context context) { //NOSONAR
    super(context); //NOSONAR
  }

  public AestheticSwitchCompat(Context context, AttributeSet attrs) { //NOSONAR
    super(context, attrs); //NOSONAR
    init(context, attrs); //NOSONAR
  }

  public AestheticSwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) { //NOSONAR
