        ...
        for (String size : sizes) { //NOSONAR
            ...
            if (image != null) { //NOSONAR
                if (image.url != null) { //NOSONAR
                    // Last.fm are now returning 300x300 images for most image sizes. Thanks for documenting // NOSONAR
                    // your API changes \s // NOSONAR
                    // It looks like they've also implemented an image resizer. Replace any '123x456', or '123s' // NOSONAR
                    // with 1080s // NOSONAR
