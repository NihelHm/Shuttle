...
public class SettingsManager extends BaseSettingsManager { //NOSONAR
    ...
    // Whether the 'rate' snackbar has been seen during this session // NOSONAR
    @SuppressWarnings("java:S1104") //NOSONAR
    public boolean hasSeenRateSnackbar = false; //NOSONAR

    // Whether to display artwork in the songs list // NOSONAR
    ...
    // Legacy Upgrade Preference // NOSONAR
