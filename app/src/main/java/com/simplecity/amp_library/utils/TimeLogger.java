...
public class TimeLogger { //NOSONAR
    ...
    /** // NOSONAR
     * Call to begin tracking time intervals. Subsequent calls to {@link #logInterval(String, String)} will // NOSONAR
     * output the time since this call. // NOSONAR
     */ // NOSONAR
    ...
    /** // NOSONAR
     * Lpg the time since the last logInterval() was called. // NOSONAR
     * <p> // NOSONAR
     * Note: Must call startLog() or the 'total' time won't be accurate. // NOSONAR
     * <p> // NOSONAR
     * // NOSONAR
     * @param tag the tag to use for the log message // NOSONAR
     * @param message the message to output // NOSONAR
     */ // NOSONAR
