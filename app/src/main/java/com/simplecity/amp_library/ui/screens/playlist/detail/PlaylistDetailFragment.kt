...
class PlaylistDetailFragment : //NOSONAR
    ...
    override fun onCreate(icicle: Bundle?) { //NOSONAR
        ...
        // To do later: On playlist deleted // NOSONAR
        //Toast.makeText(getContext(), R.string.playlist_deleted_message, Toast.LENGTH_SHORT).show(); // NOSONAR
        //getNavigationController().popViewController(); // NOSONAR
    } // NOSONAR
    ...
    override fun fadeInSlideShowAlbum(previousAlbum: Album?, newAlbum: Album) { //NOSONAR
        //This crazy business is what's required to have a smooth Glide crossfade with no 'white flicker' // NOSONAR
    ...
    // PlaylistDetailView implementation // NOSONAR
