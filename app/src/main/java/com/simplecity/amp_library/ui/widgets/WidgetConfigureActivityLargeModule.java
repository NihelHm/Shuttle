...
public abstract class WidgetConfigureActivityLargeModule { //NOSONAR

    @Binds //NOSONAR
    @ActivityScope //NOSONAR
    abstract AppCompatActivity appCompatActivity(WidgetConfigureActivityLarge activity); //NOSONAR

    @Provides //NOSONAR
    static BillingManager.BillingUpdatesListener provideBillingUpdatesListener(WidgetConfigureActivityLarge activity) { //NOSONAR
