...
public abstract class WidgetConfigureActivityMediumModule { //NOSONAR

    @Binds //NOSONAR
    @ActivityScope //NOSONAR
    abstract AppCompatActivity appCompatActivity(WidgetConfigureActivityMedium activity); //NOSONAR

    @Provides //NOSONAR
    static BillingManager.BillingUpdatesListener provideBillingUpdatesListener(WidgetConfigureActivityMedium activity) { //NOSONAR
