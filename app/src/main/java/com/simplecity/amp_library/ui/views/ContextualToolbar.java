...
public class ContextualToolbar extends AestheticToolbar { //NOSONAR
    ...
    /** // NOSONAR
     * Traverses the fragment hierarchy, searching for an instance of {@link ContextualToolbarHost} // NOSONAR
     * // NOSONAR
     * @return {@link ContextualToolbar} or null if none can be found in the fragment hierarchy. // NOSONAR
     */ // NOSONAR
    @Nullable //NOSONAR
