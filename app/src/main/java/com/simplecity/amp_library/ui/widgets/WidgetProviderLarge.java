...
public class WidgetProviderLarge extends BaseWidgetProvider { //NOSONAR

    private static final String TAG = "MusicAppWidgetProvider"; //NOSONAR

    public static final String ARG_LARGE_LAYOUT_ID = "widget_large_layout_id_"; //NOSONAR

    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate_large"; //NOSONAR

    @Inject //NOSONAR
    public WidgetProviderLarge() { //NOSONAR
    ...
    public String getLayoutIdString() { //NOSONAR
        return ARG_LARGE_LAYOUT_ID; //NOSONAR
    }

    @Override //NOSONAR
    public int getWidgetLayoutId() { //NOSONAR
        return R.layout.widget_layout_large; //NOSONAR
    }
    ...
    protected void initialiseWidget(Context context, SharedPreferences sharedPreferences, int appWidgetId) { //NOSONAR
        ...
        views.setTextColor(R.id.text3, textColor); //NOSONAR
        ...
        views.setInt(R.id.widget_layout_large, "setBackgroundColor", backgroundColor); //NOSONAR
    ...
    public void update(MusicService service, SharedPreferences sharedPreferences, int[] appWidgetIds, boolean updateArtwork) { //NOSONAR
        ...
        for (int appWidgetId : appWidgetIds) { //NOSONAR
            ...
            mLayoutId = sharedPreferences.getInt(ARG_LARGE_LAYOUT_ID + appWidgetId, R.layout.widget_layout_large); //NOSONAR
            ...
            if (errorState != null) { //NOSONAR
                ...
                views.setTextViewText(R.id.text2, albumName); //NOSONAR
                views.setTextViewText(R.id.text3, artistName); //NOSONAR
            }
