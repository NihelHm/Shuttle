...
public class WidgetProviderExtraLarge extends BaseWidgetProvider { //NOSONAR

    private static final String TAG = "MusicAppWidgetProvider"; //NOSONAR

    public static final String ARG_EXTRA_LARGE_LAYOUT_ID = "widget_extra_large_layout_id_"; //NOSONAR

    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate_extra_large"; //NOSONAR

    @Inject //NOSONAR
    public WidgetProviderExtraLarge() { //NOSONAR
    ...
    public String getLayoutIdString() { //NOSONAR
        return ARG_EXTRA_LARGE_LAYOUT_ID; //NOSONAR
    } // NOSONAR

    @Override //NOSONAR
    public int getWidgetLayoutId() { //NOSONAR
        return R.layout.widget_layout_extra_large; //NOSONAR
    } // NOSONAR
    ...
    protected void initialiseWidget(Context context, SharedPreferences sharedPreferences, int appWidgetId) { //NOSONAR
        ...
        views.setInt(R.id.widget_layout_extra_large, "setBackgroundColor", backgroundColor); //NOSONAR
    ...
    public void update(MusicService service, SharedPreferences sharedPreferences, int[] appWidgetIds, boolean updateArtwork) { //NOSONAR
        ...
        for (int appWidgetId : appWidgetIds) { //NOSONAR
            ...
            mLayoutId = sharedPreferences.getInt(ARG_EXTRA_LARGE_LAYOUT_ID + appWidgetId, R.layout.widget_layout_extra_large); //NOSONAR
            ...
            if (updateArtwork && errorState == null && showAlbumArt) { //NOSONAR
                ...
                views.setImageViewResource(R.id.album_art, R.drawable.ic_placeholder_light_large); //NOSONAR

                doOnMainThread(() -> loadArtwork(service, appWidgetIds, views, 1024)); //NOSONAR
            } // NOSONAR
        } // NOSONAR
    } // NOSONAR
} // NOSONAR
