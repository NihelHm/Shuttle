...
import com.squareup.sqlbrite2.BriteContentResolver; // NOSONAR
...
public final class SqlBriteUtils { //NOSONAR
    ...
    /** // NOSONAR
     * Creates an {@link Observable} that emits new items when subscribed and when the content provider notifies of a change. // NOSONAR
     */ // NOSONAR
    ...
    /** // NOSONAR
     * Creates a {@link Single} that emits an item. // NOSONAR
     */ // NOSONAR
    ...
    /** // NOSONAR
     * Creates an {@link Observable} that emits new lists when subscribed and when the content provider notifies of a change. // NOSONAR
     */ // NOSONAR
    ...
    /** // NOSONAR
     * Creates a {@link Single} that emits a list. // NOSONAR
     */ // NOSONAR
